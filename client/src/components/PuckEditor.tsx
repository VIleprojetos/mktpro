                          ...
                          case 'image':
                            return (
                              <img
                                ...
                                alt="Component"
                                style={{ ...component.styles, ...baseImageStyles }}
                              />
                            );
                          case 'button':
                            return (
                              <button style={{ ...component.styles, ...baseButtonStyles }}>
                                {component.content}
                              </button>
                            );
                          case 'spacer':
                            return <div style={{ ...component.styles, ...spacerInteractionStyles }} />;
                          default:
                            return (
                              <div
